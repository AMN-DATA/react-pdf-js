  ...
  (0, _createClass3.default)(Pdf, [{
    ...
    value: function renderPdf() {
      ...
      if (page) {
        ...
        var unscaledViewport = page.getViewport(scale, rotate);
        var calcScale = (this.props.width || unscaledViewport.width) / unscaledViewport.width;
        var viewport = page.getViewport(calcScale, rotate);
        
        var ratio = 1;
        var devRatio = window.devicePixelRatio || 1;
        var backingRatio = canvasContext.webkitBackingStorePixelRatio || 1; 
